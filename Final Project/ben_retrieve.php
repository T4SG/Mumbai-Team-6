      ...
      <div class="row">
        ...
        <h1 margin-left="30%" class="page-header">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The School List</h1>
            ...
            <table class="table table-striped table-responsive">
              ...
              <tbody>
<?php
$query="select * from schools order by beneficiary desc";
                ...
                <div class="row">
                   <div class="col-lg-12">
                     ...
                     <div class="col-lg-8 darken">
                         	<div class="figure"><img class="featured-image" src="<?php echo "images/$row[20]"; ?>"></div>
                           			<div class="featured-image-info" style="text-align:center;">
                           			<span >
                            			 <h2><?php echo $row[1]; ?></h2>
                            			 <h3>Impact Score : <?php echo $row[9]; ?></h3>
