...
<li><a href="cli_res_retrieve.php">Climatic Resilience</a></li>
			...
			<li><a href="weighted.html">Customize Priorities</a></li>
          </ul>
    </div><!--  -->
...
<?php
$query="select pic,name,country,(cli_res*wcli_res+cost*wcost+will*wwill+avl_res*wavl_res+sus_inf*wsus_inf+beneficiary*wbeneficiary+comm_inv*wcomm_inv+princi_inv*wprinci_inv) as impact from schools order by impact";
                ...
                <div class="row">
                   <div class="col-lg-12">
                     ...
                     <div class="col-lg-8 darken">
                          <div class="figure"><img class="featured-image" src="<?php echo "images/$row[0]"; ?>"></div>
                                <div class="featured-image-info" style="text-align:center;">
                                <span >
                                   <h2><?php echo $row[1]; ?></h2>
                                   <h3>Impact Score : <?php echo  $row[3] ?></h3>
                                   <h3><i class="fa fa-map-marker fa-lg"></i><?php echo $row[2];?> </h3>
                                 </span>
                                </div>
                          </div>
                     </div>
